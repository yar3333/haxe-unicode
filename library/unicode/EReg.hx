...
class EReg
{
	...
	static var regexp_new_options = neko.Lib.load("unicode","regexp_new_options",2);
	static var regexp_match = neko.Lib.load("unicode","regexp_match",4);
	static var regexp_matched = neko.Lib.load("unicode","regexp_matched",2);
	static var regexp_matched_pos : Dynamic -> Int -> { pos : Int, len : Int } = neko.Lib.load("unicode","regexp_matched_pos",2);
}
